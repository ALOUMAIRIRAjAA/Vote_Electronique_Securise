...
.back h3 mb-3 font-weight-normal{
font-weight: bolder;
}
...
<body background="../img/Elections-Vote.jpg">
	<div class="container">
		<center>
			<div class="back">
				<form class="form-signin" method="post"
					action="/webapp/vues/voteDone.jsp">
                    ...
                    <input type="text" id="inputEmail"class="form-control" name="nom" placeholder="Enter nom" required
				     ...
				     <input type="text" id="inputEmail" class="form-control" name="prenom" placeholder="Enter prenom" required autofocus> <label>Date of birth</label> 
